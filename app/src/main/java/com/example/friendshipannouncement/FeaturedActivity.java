    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference("Featured");
                ...
                if(!(purl == null)){
                    ...
                    Toast.makeText(FeaturedActivity.this, "set image", Toast.LENGTH_SHORT).show();
                    return;
                ...
                db.child(position.getText().toString()).updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(FeaturedActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                        startActivity(i);
                    }
                });
            }
...
//                progress.setVisibility(View.VISIBLE);
    ...
    private void uploadImageToFirebase(Uri imageUri) {
        ...
        final StorageReference fileRef = storageReference.child("Featured/" + position.getText().toString() + "profile.jpg");
...
//                        progress.setVisibility(View.GONE);
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(FeaturedActivity.this, "Failed.", Toast.LENGTH_LONG).show();
//                progress.setVisibility(View.GONE);
            }});
    }
}